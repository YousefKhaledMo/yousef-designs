  ...
  const content = (
    <>
      ...
      {icon && (
        <span 
          ref={contentRef}
          className="relative flex items-center justify-center w-11 h-11 rounded-full bg-white/10 transition-transform duration-300 ease-[var(--ease-primary)] group-hover:translate-x-0.5 group-hover:-translate-y-0.5"
        >
          <ArrowRight
